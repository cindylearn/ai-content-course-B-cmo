...
### Round 1 — 语言（主讲人从哪来只 mention，不硬卡）

> 🔴 **先 test 一支正常口播就行 —— 直接照脚本 persona 出主播，不用先装 05。**
> 只有她要**全片同一个人 / 真人本尊 / 锁定数字人**时，才跟她说：要先做 `05 AI数字人` 拿 3 张脸参考图回来（选人/九宫格在 05，04 不选）。

**Q1. 说话语言 / Language**（一定要问，别默认英文）
1. 🇲🇾 马来西亚华语/中文（默认）· 2. 中英混 Rojak · 3. English · 4. Bahasa Malaysia
> 选的语言 = 台词语言 + 选声语言，全片统一。

（有 05 锁好的 3 张脸参考图？→ 一起用锁人；没有 → 照脚本 persona 直接出，先 test。）
