...
🔴🔴 **04 只管「把脚本拍成视频」，不选人、不造脸。** 主角 = 脚本 persona（贴受众）+ 开工前就在 `suma-ai-05-avatar` 备好的脸参考图；脸从哪来、AI人/真人、九宫格、性别气质 —— 全在 05，04 不碰。（角色类型 AI人/真人/纯图文无主播，在脚本/立项阶段就定。）
🔴 **开工只确认（一题一张选项卡，别默认）：**
1. **脸参考图备好了没** —— 真人 3 张 or 05 做好的数字人 3 张；🔴 没备好 = 还没做 05 → 先去做 05，别在 04 现问现做。（纯图文无主播的内容 → 不需要脸，跳过。）
